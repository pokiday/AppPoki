...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 365477260, ; hash 0x15c8bd8c, from name: AppPoki
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2701376004, ; hash 0xa103ba04, from name: aot-AppPoki
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 301
	...
	%struct.DSOCacheEntry {
		i64 2724525471, ; hash 0xa264f59f, from name: aot-AppPoki.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 305
	...
	%struct.DSOCacheEntry {
		i64 2941671139, ; hash 0xaf5656e3, from name: AppPoki.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 332
	...
	%struct.DSOCacheEntry {
		i64 3431097761, ; hash 0xcc8265a1, from name: libaot-AppPoki.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 390
	...
	%struct.DSOCacheEntry {
		i64 3593150623, ; hash 0xd62b209f, from name: libaot-AppPoki
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 407
