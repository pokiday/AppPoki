...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1660635192538641051, ; hash 0x170bc2e8c0c7329b, from name: aot-AppPoki
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 7157742314878241040, ; hash 0x635568b648198910, from name: AppPoki
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 10906459966756726568, ; hash 0x975b878e0b8da728, from name: AppPoki.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 271
	...
	%struct.DSOCacheEntry {
		i64 11669754826955049455, ; hash 0xa1f34c2fa48e49ef, from name: aot-AppPoki.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 298
	...
	%struct.DSOCacheEntry {
		i64 13464261008559453523, ; hash 0xbadaaa0cf2543553, from name: libaot-AppPoki
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 348
	...
	%struct.DSOCacheEntry {
		i64 17562885491410265659, ; hash 0xf3bbe74d625ee63b, from name: libaot-AppPoki.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AppPoki.dll.so
		ptr null; void* handle (0x0)
	}, ; 452
...
@.env.3 = private unnamed_addr constant [37 x i8] c"9601d7bb-e41b-478c-8d2e-de8062d3f6cd\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.apppoki\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-AppPoki.dll.so\00", align 16
